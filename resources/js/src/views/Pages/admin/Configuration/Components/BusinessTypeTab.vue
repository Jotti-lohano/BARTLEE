                        ...
                        <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                          <router-link :to="{ name : 'admin.configuration.edit',params : {type: 'business-type',id : item.id} }" class="dropdown-item mb-1"><i class="bi bi-pencil-square pr-2 "></i>Edit</router-link>
