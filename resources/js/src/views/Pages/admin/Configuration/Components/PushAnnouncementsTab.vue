                        ...
                        <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                          <router-link :to="{ name : 'admin.configuration.show',params : {type: 'push-announcements',id : item.id} }" class="dropdown-item mb-1"><i class="bi bi-eye table-eye pr-2 "></i>View</router-link>
                                    </div>
                                </div>
                            </td>
                    </template>
